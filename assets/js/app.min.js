function equalizeHeight() {
    ...
    e.css({"min-height": $(window).height() - 30 + "px"}), $(window).resize(function () {
        e.css({"min-height": $(window).height() - 30 + "px"})
    })
}
function onScroll() {
    var e = $(document).scrollTop();
    $("#menu li.parallax a").each(function () {
...
$(window).bind("scroll", function () {
    ...
    jQuery(window).scroll(function () {
        ...
        return e.preventDefault(), jQuery("html, body").animate({scrollTop: 0}, o), !1
    })
